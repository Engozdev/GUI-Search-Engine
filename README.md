...
В данном проекте реализован один из вариантов поискового индекса - [инвертировнный индекс](https://en.wikipedia.org/wiki/Inverted_index).
...
Таким образом, реализовано два приложения - индексатор (подготовка поискового индекса) и поиск (программу, осуществляющую непосредственно поиск по построенному индексу)

## Требования

### Требования к индексирующей программе

- Декстоп-приложение на фреймфорке Qt.
